...
st.write("Your Health, Our Priority: Seamlessly Integrated EHR")
st.image("ehr.jpg", caption='Efficient, Comprehensive, and Personalized Healthcare Management with our EHR System', use_column_width=True)
# User authentication
...
def main():
    ...
    with col1:
        ...
        st.image("patientrecord.jpg",caption='PatientRecord')
        patient_records = []
    ...
    with col2:
        ...
        st.image("appointment.jpg",caption='Appointment')
        appointment_records = []
    ...
    with col1:
        ...
        st.image("dctr.jpg", caption="Doctor's Schedule")
        doctor_schedules = []
    ...
    with col2:
        # Display Invoices
        st.subheader("Invoices")
        st.image("invo.jpg", caption="Invoices")
        invoice_records = []
    ...
    if make_payment:
        ...
        st.image("pay.jpg", caption="Payment")
    ...
    if generate_report:
        ...
        st.image("generatereport.jpg", caption="Generate Report")
    ...
    with col1:
        ...
        st.image("appreport.jpg", caption="Appointment Report")
        report_data = []
    ...
    # Display Patient Report
        ...
        st.image("pnt.jpg", caption="Patient Report")
        report_data = []
    ...
    if user["is_admin"]:
        ...
        if manage_users:        
            ...
            st.image("dblogo.jpg", caption="Managing Users")
            ...
            st.image("adduser.jpg", caption="Adding Users")
...
#remove users
            ...
            st.image("removinguser.jpg", caption="Removing Users")
            all_users = users_collection.find({})
            user_records = []
            for user in all_users:
                user_records.append({
