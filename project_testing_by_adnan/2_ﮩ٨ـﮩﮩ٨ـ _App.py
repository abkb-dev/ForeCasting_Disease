...
# Add other content to the main area
import streamlit as st

st.markdown("<h1 style='text-align: center;'>PrognosisPulseWebApp</h1>", unsafe_allow_html=True)

st.write("Welcome to PrognosisPulseWebApp, your gateway to predictive healthcare powered by advanced machine learning algorithms and the intuitive Streamlit framework. In today's fast-paced world, timely diagnosis is paramount, and PrognosisPulseApp stands at the forefront, offering predictive insights into multiple diseases..")
...
# Liver the hepatitis prediction model
liver_model = joblib.load('models/liver_model.sav')
# Load the lung cancer prediction model
lung_cancer_model = joblib.load('models/lung_cancer_model.sav')

# Load the osteoporosis prediction model
Osteoporosis_Model = joblib.load('C:\\Users\\Mohammed Ahmed\\OneDrive\\Desktop\\prognosispulseapp\\project testing by adnan\\Datasets\\Code\\Osteoporosis_new.sav')
